...
<p align="center">
  <img src="./data/show_speaking.PNG" width="48%" alt="流式同传与 TTS 播报状态" />
  <img src="./data/show_summary.PNG" width="48%" alt="退出拦截与智能会议纪要状态" />
</p>
<p align="center">
...
* **多级并发流水线**：在流式模式下，采用了 `Goroutine` + `RingBuffer` + `Channel` 的架构，确保音频采集、ASR 识别、LLM 翻译、TTS 播报互不阻塞。
